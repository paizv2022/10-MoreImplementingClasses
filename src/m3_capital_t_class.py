    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        t = letter_thickness / 2
        self.h_rect = rg.Rectangle(rg.Point(x - (width / 2), y + t), rg.Point(x + (width / 2), y - t))
        self.v_rect = rg.Rectangle(rg.Point(x - t, y - t), rg.Point(x + t, y + height - t))
    ...
    def clone(self):
        ...
        #######################################################################
        thickness = self.v_rect.get_lower_right_corner().x - self.v_rect.get_lower_left_corner().x
